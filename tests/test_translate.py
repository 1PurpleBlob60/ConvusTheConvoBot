...
def test_translate_text_returns_string_for_supported_language():
    ...
    assert result.strip()
    assert result.rstrip(".!?") == "Bonjour"


def test_translate_text_accepts_full_language_names_and_iso_codes():
    assert responses.translate_text("hello", "french").rstrip(".!?") == "Bonjour"
    assert responses.translate_text("hello", "fr").rstrip(".!?") == "Bonjour"
...
def test_translate_shortcuts_and_command_aliases():
    ...
    assert responses.translate_text("hello", "f").rstrip(".!?") == "Bonjour"
    assert responses.translate_text("hello", "s").rstrip(".!?") == "Hola"
    assert responses.translate_text("hello", "g").rstrip(".!?") == "Hallo"
